...
class TestAbs(unittest.TestCase):
    def test1(self):
        a_test(self, "http://suninjuly.github.io/registration1.html")

    def test2(self):
        a_test(self, "http://suninjuly.github.io/registration2.html")
